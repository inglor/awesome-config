...
volbar.widget:buttons(awful.util.table.join(
   ...
   awful.button({ }, 4, function () exec("amixer -q set Master 3%+", false) vicious.force({volbar, volwidget}) end),
   awful.button({ }, 5, function () exec("amixer -q set Master 3%-", false) vicious.force({volbar, volwidget}) end)
